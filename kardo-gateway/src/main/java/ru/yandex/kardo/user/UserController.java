...
import ru.yandex.kardo.util.DirectionMapper;
...
public class UserController {
    ...
    public List<UserCommunityShortDto> getAllUserCommunity(
        ...
        return userClient.getAllUserCommunity(directions != null ?
    ...
    public UserCommunityFullDto getOtherUserById(
        ...
        return userClient.getOtherUserById(userId);
    }
    ...
    public UserProfileResponse getUserProfile() {
        return userClient.getUserProfile(authenticationService.getAuthenticationInfo().getId());
    }
    ...
    public UserProfileSettingsResponse getUserProfileSettings() {
        return userClient.getUserProfileSettings(authenticationService.getAuthenticationInfo().getId());
    }
