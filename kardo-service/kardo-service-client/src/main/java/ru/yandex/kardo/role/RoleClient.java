...
import static ru.yandex.kardo.exception.NotFoundException.ROLE_NOT_FOUND_MESSAGE;
...
public class RoleClient {
    ...
    @Autowired
    public RoleClient(@Value("${kardo-service.url}") String serverUrl, RestTemplateBuilder builder) {
